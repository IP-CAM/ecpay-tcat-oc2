...
class ControllerShippingTcat extends Controller {
    ...
    protected function validate() {
        ...
        } else if (mb_strlen($this->request->post['tcat_sender_address']) < 7) { // 字元限制需大於 7 個字元，且不可超過 60 個字元
            $this->error['warning10'] = $this->language->get('error_sender_address');
        } else if (mb_strlen($this->request->post['tcat_sender_address']) > 60) { // 字元限制需大於 7 個字元，且不可超過 60 個字元
            $this->error['warning10'] = $this->language->get('error_sender_address');
        }
